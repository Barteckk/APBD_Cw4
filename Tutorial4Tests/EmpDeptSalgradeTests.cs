...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(e => new { e.EName, Sal = e.Sal }); 
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(g => new { g.Key, Count = g.Count() }); 
        
        Assert.Contains(result, g => g.Key == 30 && g.Count == 2);
    }
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm != null).Select(e => new { e.EName, Comm = e.Comm });
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .SelectMany(emp => grades, (emp, grade) => new
            {
                EName = emp.EName,
                Grade = grade.Grade,
                IsInRange = emp.Sal >= grade.Losal && emp.Sal <= grade.Hisal
            })
            .Where(r => r.IsInRange)
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(g => new { g.Key, AvgSal = g.Average(e => e.Sal) }); 
        
        Assert.Contains(result, r => r.Key == 30 && r.AvgSal > 1000);
    }
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(e2 => e2.DeptNo == e.DeptNo).Average(e2 => e2.Sal)).ToList();
